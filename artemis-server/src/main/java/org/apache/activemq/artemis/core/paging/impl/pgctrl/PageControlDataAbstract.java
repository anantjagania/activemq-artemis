...
public abstract class PageControlDataAbstract {

   public static final byte PAGE_TX = (byte) 1;
   public static final byte PAGE_COUNT = (byte) 2;

   protected abstract byte getControlByte();
