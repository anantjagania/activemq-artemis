...
public class SNFPagedMirrorTest extends SoakTestBase {
   ...
   public static final String DC1_NODE_A = "sourcePaged/DC1";
   public static final String DC2_NODE_A = "sourcePaged/DC2";
