...
import org.apache.activemq.artemis.jms.contract.ActiveMQConnectionFactory;
import org.apache.activemq.artemis.jms.contract.ActiveMQDestination;
import org.apache.activemq.artemis.uri.ConnectionFactoryParser;
import org.apache.activemq.artemis.utils.ClassloadingUtil;
import org.jboss.logging.Logger;

/**
 * A utility class for creating ActiveMQ Artemis contract-side JMS managed resources.
 */
public class ActiveMQJMSClient {
    ...
    * information is also propagated to the contract so that it can know which server to failover onto
   ...
   /**
    * Create an ActiveMQConnectionFactory which creates session factories from a set of live servers, no HA backup information is propagated to the contract
    *
    ...
    * includes backup servers that information is also propagated to the contract so that it can know
    ...
    * no HA backup information is propagated to the contract
    *
    * @param jmsFactoryType
   ...
   /**
    * Creates a contract-side representation of a JMS Topic.
    *
    * This method is deprecated. Use {@link org.apache.activemq.artemis.jms.contract.ActiveMQSession#createTopic(String)} as that method will know the proper
   ...
   /**
    * Creates a contract-side representation of a JMS Queue.
    *
    * This method is deprecated. Use {@link org.apache.activemq.artemis.jms.contract.ActiveMQSession#createQueue(String)} (String)} as that method will know the proper
    * prefix used at the target server.
    * *
